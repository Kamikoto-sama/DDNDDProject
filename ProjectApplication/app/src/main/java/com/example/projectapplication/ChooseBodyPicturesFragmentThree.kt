    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        picture1.setOnClickListener { v ->
            bodyPictureClickHandle(
                R.drawable.choose_body_picture9,
                R.drawable.cap_back,
                "Капитан",
                activity!!,
                picture1,
        ...
        picture2.setOnClickListener { v ->
            bodyPictureClickHandle(
                R.drawable.choose_body_picture10,
                R.drawable.super_back,
                "Суперчеловек",
                activity!!,
                picture2,
                v
        ...
        picture3.setOnClickListener { v ->
            bodyPictureClickHandle(
                R.drawable.choose_body_picture11,
                R.drawable.starlord_back,
                "Лорд",
                activity!!,
                picture3,
                v
        ...
        picture4.setOnClickListener { v ->
            bodyPictureClickHandle(
                R.drawable.choose_body_picture12,
                R.drawable.bat_back,
                "Богач",
                activity!!,
                picture4,
